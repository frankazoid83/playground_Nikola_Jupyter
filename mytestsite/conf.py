...
BLOG_AUTHOR = "frankazoid"  # (translatable)
BLOG_TITLE = "Test Nikola site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://mytestsite.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://mytestsite.org/"
BLOG_EMAIL = "frankazoid@testmail.com"
BLOG_DESCRIPTION = "This is a test project in Nikola"  # (translatable)
